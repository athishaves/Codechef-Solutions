...
import java.io.*;
  ...
  class MATXOR {
	...
	public static void func () {
		int n = sc.nInt(), m = sc.nInt(), k = sc.nInt();
		int res = 0;
		
		int[] diff = new int[n+m+5];
	...
	//static <T> void print (T... t) { for (T i : t) System.out.print(i); }
	//static <T> void printASpace (T... t) { for (T i : t) System.out.print(i + " "); }
