...
import java.io.*;
  ...
  class SUBMEDIA {
	...
	public static void func () {
	    ...
	    PriorityQueue<Obj> q = new PriorityQueue<>(k+1, (b,c) -> Long.compare(b.val, c.val));
	    
	    for (int i=0; i<k; i++) q.add( new Obj(i, sc.nLong()) );
	    for (int i=k; i<n; i++) {
	        q.add( new Obj(i, sc.nLong()) );
	        q.remove();
	    }
